...
<head>
    ...
    <title><fmt:message key="index.head"/></title>
    <!-- Favicon-->
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <!-- Page content-->
        <div class="container-fluid">
            <h1 class="mt-4"><fmt:message key="welcome.heading"/></h1>
            <br>
            <p><fmt:message key="index.p1"/></p>
            <p><fmt:message key="index.p2"/></p>
            <p><fmt:message key="index.p3"/></p>
            <p><fmt:message key="index.p4"/></p>
            <p><fmt:message key="index.p5"/></p>
        </div>
        <div class="container-fluid">
            <h1 class="text-center"><fmt:message key="index.new"/></h1>
            <div class="gallery">
                <div class="big">
                    <img src="assets/start.jpg" alt="Start">
                </div>
                <div class="small">
                    <a href="assets/big1.png"><img src="assets/mini1.png" alt="Mini1"/></a>
                    <a href="assets/big2.jpg"><img src="assets/mini2.png" alt="Mini2"/></a>
                </div>
            </div>
            <!-- Copyright -->
            <div class="container-fluid">
