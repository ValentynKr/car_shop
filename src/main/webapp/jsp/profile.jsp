...
<head>
    ...
    <title><fmt:message key="profile.head"/></title>
    <!-- Favicon-->
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <!-- Page content-->
        <div class="container-fluid">
            <h1 class="mt-4"><fmt:message key="profile.heading"/></h1>
            <hr>
            <p><fmt:message key="profile.p1"/></p>
            <br>
            <p class="text-center"><strong><fmt:message key="profile.avatar"/>:</strong></p>
            <img class="mx-auto d-block" src='${pageContext.request.contextPath}/user-images/${sessionScope.avatarName}' alt="avatar" width="300" height="300"/>
            <br>
            <p class="text-center"><strong><fmt:message key="profile.rating"/>:</strong> 7.00</p>
            <p class="text-center"><strong><fmt:message key="profile.name"/>:</strong> ${sessionScope.user.firstName} ${sessionScope.user.secondName}</p>
            <p class="text-center"><strong><fmt:message key="profile.email"/>:</strong> ${sessionScope.user.email}</p>
            <p class="text-center"><strong><fmt:message key="profile.birthdate"/>:</strong> ${sessionScope.user.birthDate}</p>
            <p class="text-center"><strong><fmt:message key="profile.phone"/>:</strong> ${sessionScope.user.phoneNumber}</p>
            <hr>
            <br>
        </div>
        <div class="container-fluid">
