...
<head>
    ...
    <title><fmt:message key="success.head"/></title>
    <!-- Favicon-->
...
<div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
        ...
        <!-- Page content-->
        <div class="container-fluid">
            <h1 class="mt-4"><fmt:message
                    key="successful.registration.heading"/>, ${sessionScope.user.firstName} ${sessionScope.user.secondName}!</h1>
            <br>
            <p><fmt:message key="successful.registration.p1"/></p>
            <p><fmt:message key="successful.registration.p2"/></p>
        </div>
        <div class="container-fluid">
            <!-- Copyright -->
            <div class="container-fluid">
